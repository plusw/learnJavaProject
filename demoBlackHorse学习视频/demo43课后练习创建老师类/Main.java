...
public class Main{
	public static void main(String[] args){
		BaseTeacher zhangsan=new BaseTeacher("张三",23);
		System.out.println(""+zhangsan.name+"老师"+"..."+zhangsan.age);
		zhangsan.teach();
		WorkTeacher lisi=new WorkTeacher("李四",24);
		System.out.println(""+lisi.name+"老师"+"..."+lisi.age);
		lisi.teach();
